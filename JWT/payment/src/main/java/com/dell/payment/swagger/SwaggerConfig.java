 ...
 * 
 */
package com.dell.payment.swagger;
...
public class SwaggerConfig {
	...
	private ApiInfo metaData() {
		ApiInfo apiInfo = new ApiInfo("Payment Service",
				"Payment Service REST API for Payment System to display security protocols", "1.0", "Terms of service",
